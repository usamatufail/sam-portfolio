          ...
          <div className="flex items-center justify-center">
            <div>
              ...
              <p className="text-[18px] max-w-[450px]">
                As a programmer, Sam is a skilled and knowledgeable individual
                with a passion for creating and improving softwares and solving
                problems. Sam is highly analytical, able to break down complex
                problems into manageable pieces and devise efficient solutions.
                ...
                productive work environment. Overall, Sam can be a valuable
                asset to any organization, with the skills and expertise to
                drive success in the fast-paced and constantly evolving world of
                technology. Sam&apos;s passion for programming and his
                dedication to continuously learning and improving make him an
